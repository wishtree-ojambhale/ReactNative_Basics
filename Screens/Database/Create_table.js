    ...
    txn.executeSql(
      ...
      function (tx, res) {
        ...
        if (res.rows.length == 0) {
          ...
          txn.executeSql(
            'CREATE TABLE IF NOT EXISTS table_todo(user_id INTEGER PRIMARY KEY AUTOINCREMENT, user_title VARCHAR(20), user_task VARCHAR(255), user_color VARCHAR(20), user_date VARCHAR(30),user_category VARCHAR(10), user_currentDateTime VARCHAR(15))',
            [],
          );
        }
      },
